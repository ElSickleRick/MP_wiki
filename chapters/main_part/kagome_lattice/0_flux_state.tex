...
\textcolor{red}{Is it important to consider the phases of the states here?}
...
but is not yet in the form of the Weyl equation. \textcolor{red}{This can probably achieved by rotating the basis in the degenerate subsapce?}

\textcolor{blue}{Sanity check; directly linearizing the algabraic expressions for $\varepsilon_{1,2}(\vec{q})$ gives
\begin{equation}
Please work
\end{equation}
}
