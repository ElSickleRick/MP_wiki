...
\textcolor{red}{I fucked up here, it should be $\sin{\vec{q}\vec{\delta}_2}$ and  $\cos{\vec{q}\vec{\delta_3}}$. Luckily, this also corresponds to a unit cell with $0$ flux in down traingles and $\pi$ flux in the up traingles. (Graphically  this means all bonds in the in the 2-direction are positive while the ones in the 3-direction alternate.)}
